...
from .utility_class import SourceVector, clamp, Deletion, Edit, Insertion, Substitution, Vind
...
class LSTMFixerUpper:
    ...
    def __init__(self, model: DualLSTMModel, vocabulary: Vocabulary, k: int=1) -> None:
        """
    ...
    def fix(self, source_ids) -> Sequence[Edit]:
        """
        ...
        for index, pred in enumerate(predictions):
            ...
            # truth.
            result = IndexResult(index, file_vector, prefix_pred, suffix_pred, vind)
...
class IndexResult(SupportsFloat):
    ...
    def __repr__(self) -> str:
        return (f'IndexResult(index={self.index!r}, '
                f'score={float(self)})')
    ...
    def _top(self, vector, k=1) -> np.ndarray:
